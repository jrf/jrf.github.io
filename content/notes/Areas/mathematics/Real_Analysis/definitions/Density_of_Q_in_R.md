...
Using the [Archimedean_Property](/notes/areas/mathematics/real_analysis/definitions/archimedean_property/), we may pick $n \in \mathbb{N}$ large enough such that
