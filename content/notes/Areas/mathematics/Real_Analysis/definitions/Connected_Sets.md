...
# [Connected_Sets](/notes/areas/mathematics/real_analysis/definitions/connected_sets/)
...
A set $E \subseteq \mathbb{R}$ is *disconnected* if it can be written as $E = A \cup B$ where $A$ and $B$ are nonempty, [disjoint](/notes/areas/mathematics/real_analysis/definitions/disjoint/) sets such that $\overline{A} \cap B = \emptyset$ and $A \cap \overline{B} = \emptyset$.
