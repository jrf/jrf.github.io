...
# [Extreme_Value_Theorem](/notes/areas/mathematics/real_analysis/definitions/extreme_value_theorem/)
...
If $f:[a,b] \rightarrow \mathbb{R}$ is [continuous](/notes/areas/mathematics/real_analysis/definitions/continuity/) on the closed interval $[a,b]$, then $f$ attains a maximum and minimum value. That is, there exist $x_0, x_1 \in [a,b]$ such that $f(x_0) \leq f(x) \leq f(x_1)$ for all $x \in [a,b]$.
