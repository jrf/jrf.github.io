...
# [Cauchy_sequence](/notes/areas/mathematics/real_analysis/definitions/cauchy_sequence/)

## Definition

A [sequence](/notes/areas/mathematics/real_analysis/definitions/sequence/) $\left. \left( a_{n} \right) \right.$ is called a *Cauchy sequence* if, for every $\epsilon > 0$, there exists an $N \in \mathbb{N}$ such that whenever $m,n \geq N$ it follows that $\left| a_{n} - a_{m} \right| < \epsilon$.

Compare this to the definition of [convergence](/notes/areas/mathematics/real_analysis/definitions/convergence/).
