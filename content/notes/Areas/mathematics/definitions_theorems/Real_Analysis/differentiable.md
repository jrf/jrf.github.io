...
Let $g:A \rightarrow \mathbb{R}$ be a [function](/notes/areas/mathematics/definitions_theorems/set_theory/function/) defined on an interval $A$. Given $c \in A$, the *derivative* of $g$ at $c$ is defined by
