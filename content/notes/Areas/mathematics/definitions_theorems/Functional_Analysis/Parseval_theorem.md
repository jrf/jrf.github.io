...
**Parseval's theorem** (also known as **Rayleigh's energy theorem** in the context of Fourier transforms) states that the total energy of a signal is preserved under the [Fourier transform](/notes/areas/mathematics/definitions_theorems/functional_analysis/fourier_transform/).
