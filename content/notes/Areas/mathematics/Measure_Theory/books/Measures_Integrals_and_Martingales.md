...
The least we should expect from a reasonable [measure](/notes/areas/mathematics/measure_theory/definitions/measure/) $\mu$ is that it is
...
> Where was [sigma-additivity](/notes/areas/mathematics/measure_theory/definitions/sigma-additivity/) used when calculating the length of the [Cantor_set](/notes/areas/mathematics/real_analysis/definitions/cantor_set/)?

By construction of the [Cantor_set](/notes/areas/mathematics/real_analysis/definitions/cantor_set/), we have
...
Again, [sigma-additivity](/notes/areas/mathematics/measure_theory/definitions/sigma-additivity/) comes in the form of a limit (compare with Exercise 1.2). Notice that $S$ is non-empty as it contains the vertices of all black triangles (see figure above) of each stage.

# Chapter 2: The Pleasures of Counting -- Examples

See Exercise 1.2.3(c, d) in [Understanding_Analysis](/notes/areas/mathematics/real_analysis/books/understanding_analysis/) for a proof of (2.1).

See Exercise 1.2.5 in [Understanding_Analysis](/notes/areas/mathematics/real_analysis/books/understanding_analysis/) for a proof of [de_Morgan's_laws](/notes/areas/mathematics/set_theory/definitions/de_morgans_laws/) (2.2).

See Exercise 1.2.13(c) in [Understanding_Analysis](/notes/areas/mathematics/real_analysis/books/understanding_analysis/) for a proof of (2.3).

See Exercise 1.2.7 in [Understanding_Analysis](/notes/areas/mathematics/real_analysis/books/understanding_analysis/) for a proof of (2.5).
...
Proof: We have to show that no [injection](/notes/areas/mathematics/set_theory/definitions/injection/) $\Phi:X \rightarrow \mathcal{P}\left. (X) \right.$ can also be a [surjection](/notes/areas/mathematics/set_theory/definitions/surjection/). Fix such an [injection](/notes/areas/mathematics/set_theory/definitions/injection/) and define
...
Note that $\Phi\left. (x) \right.$ and $B$ are both sets. Clearly, $B \in \mathcal{P}\left. (X) \right.$. Now, let us proceed via [proof_by_contradiction](/notes/areas/mathematics/proof_techniques/definitions/proof_by_contradiction/) and assume that $\Phi$ is a [surjection](/notes/areas/mathematics/set_theory/definitions/surjection/). If this were the case, then $B$, which again is always an element of $\mathcal{P}\left. (X) \right.$, must correspond to some element $z \in X$. Now, assume that $z$ is also an element of $B$ (which may not always be the case), then by construction of $B$, $z$ cannot be an element of $\Phi\left. (z) \right.$. But this implies that, since $\Phi\left. (z) \right. = B$, $z$ cannot be an element of $B$. This is impossible and thus $\Phi$ is not a [surjection](/notes/areas/mathematics/set_theory/definitions/surjection/).
...
By [de_Morgan's_laws](/notes/areas/mathematics/set_theory/definitions/de_morgans_laws/) (DM) and part (i) above, we have
...
> Let $A,B,C \subseteq X$. The [symmetric_difference](/notes/areas/mathematics/set_theory/definitions/symmetric_difference/) of $A$ and $B$ is $A \bigtriangleup B ≔ \left. (A\backslash B) \right. \cup \left. (B\backslash A) \right.$. Verify that
>
> 
...
> Prove [de_Morgan's_laws](/notes/areas/mathematics/set_theory/definitions/de_morgans_laws/) (2.2) and (2.3).

For (2.2), see Exercise 1.2.5 from [Understanding_Analysis](/notes/areas/mathematics/real_analysis/books/understanding_analysis/).
...
The [indicator_function](/notes/areas/mathematics/measure_theory/definitions/indicator_function/) of a set $A \subseteq X$ is defined by
...
> Let $A,B,C \subseteq X$ and denoate by $A \bigtriangleup B$ the [symmetric_difference](/notes/areas/mathematics/set_theory/definitions/symmetric_difference/) as shown in Problem
>
> 2.  [Hint: use [indicator_function](/notes/areas/mathematics/measure_theory/definitions/indicator_function/)s for (ii) and (iii).] Show that
...
> Let $\mathcal{A}$ be a [sigma-algebra](/notes/areas/mathematics/measure_theory/definitions/sigma-algebra/). Show that
...
> $\{\varnothing,B,X\}$ is not a [sigma-algebra](/notes/areas/mathematics/measure_theory/definitions/sigma-algebra/) (unless $B = \varnothing$ or $B = X$).

Proof: By definition of a [sigma-algebra](/notes/areas/mathematics/measure_theory/definitions/sigma-algebra/), this must be true. If $B \in \mathcal{A}$, then $B^{c} \in \mathcal{A}$ as well. If $B = \varnothing$ or $B = X$, then we have the minimal [sigma-algebra](/notes/areas/mathematics/measure_theory/definitions/sigma-algebra/) in 3.3(ii). $▫$

Restating 3.3(vi):

> Trace of [sigma-algebra](/notes/areas/mathematics/measure_theory/definitions/sigma-algebra/): Let $E \subseteq X$ be any set and let $\mathcal{A}$ be some [sigma-algebra](/notes/areas/mathematics/measure_theory/definitions/sigma-algebra/) in $X$. Then
>
> 
...
>
> is a [sigma-algebra](/notes/areas/mathematics/measure_theory/definitions/sigma-algebra/) in $E$.
...
Note that $f^{- 1}$ interchanges with all set operations. Let $A,A_{j},j \in \mathbb{N}$ be sets in $\mathcal{A}$. We know then that $A = f^{- 1}\left. (A') \right.,A_{j} = f^{- 1}\left. \left( A_{j}' \right) \right.$ for suitable $A,A_{j}' \in \mathcal{A}'$. Since $\mathcal{A}'$ is, by assumption, a [sigma-algebra](/notes/areas/mathematics/measure_theory/definitions/sigma-algebra/), we have
...
> Let $X = \mathbb{R}$. Find the [sigma-algebra](/notes/areas/mathematics/measure_theory/definitions/sigma-algebra/) generated by the singletons $\{\{ x\}:x \in \mathbb{R}\}$.
...
Let $\mathcal{A} ≔ \{ A \subseteq X:\# A \leq \#\mathbb{N}\mathrm{\text{ or }}\# A^{c} \leq \#\mathbb{N}\}$ be a [sigma-algebra](/notes/areas/mathematics/measure_theory/definitions/sigma-algebra/), as in Example 3.3(v).
...
1.  If $\mathcal{G}$ is a [sigma-algebra](/notes/areas/mathematics/measure_theory/definitions/sigma-algebra/), then $\mathcal{G} = \sigma\left. \left( \mathcal{G} \right) \right.$.
...
\(i\) Since $\mathcal{G}$ is a [sigma-algebra](/notes/areas/mathematics/measure_theory/definitions/sigma-algebra/), $\mathcal{G}$ "competes" in the intersection of all [sigma-algebra](/notes/areas/mathematics/measure_theory/definitions/sigma-algebra/)s $\mathcal{C} \supseteq \mathcal{G}$ appearing in the definition of $\mathcal{A}$ in the proof of Theorem 3.4(ii). Thus, $\mathcal{G} \supseteq \sigma\left. \left( \mathcal{G} \right) \right.$ while $\mathcal{G} \subseteq \sigma\left. \left( \mathcal{G} \right) \right.$ is always true.

\(ii\) Without loss of generality, we can assume that $\varnothing \neq A \neq X$ since this would simplify the problem. Clearly, $\{\varnothing,A,A^{c},X\}$is a [sigma-algebra](/notes/areas/mathematics/measure_theory/definitions/sigma-algebra/) containing $A$ and no element can be removed without losing this property. Thus, $\{ 0,A,A^{c},X\}$ is minimal and therefore $\sigma\left. \left( \{ A\} \right) \right.$.
...
> Let $X = \left. \lbrack 0,1\rbrack \right.$. Find the [sigma-algebra](/notes/areas/mathematics/measure_theory/definitions/sigma-algebra/) generated by the sets
...
>
> Remark: A set $A$ in a [sigma-algebra](/notes/areas/mathematics/measure_theory/definitions/sigma-algebra/) $\mathcal{A}$ is called an *atom* if there is no proper subset $\varnothing \neq B \subset A$ such that $B \in \mathcal{A}$. In this sense all $A_{n}$ are all atoms.
...
> Check that the [set_function](/notes/areas/mathematics/set_theory/definitions/set_function/)s defined in Example 4.5 are [measure](/notes/areas/mathematics/measure_theory/definitions/measure/)s.

### (i)

> [Dirac_measure](/notes/areas/mathematics/measure_theory/definitions/dirac_measure/), unit mass: Let $\left. \left( X,\mathcal{A} \right) \right.$ be a [measurable_space](/notes/areas/mathematics/measure_theory/definitions/measurable_space/) and let $x \in X$ be some point. Then $\delta_{x}:\mathcal{A} \rightarrow \{ 0,1\}$, defined for $A \in \mathcal{A}$ by
>
> 
...
> Counting measure: Let $\left. \left( X,\mathcal{A} \right) \right.$ be a [measurable_space](/notes/areas/mathematics/measure_theory/definitions/measurable_space/) and $A \in \mathcal{A}$. Then
>
> 
...
> Discrete [probability_measure](/notes/areas/mathematics/measure_theory/definitions/probability_measure/): Let $\Omega = \{\omega_{1},\omega_{2},\ldots\}$ be a [countable](/notes/areas/mathematics/set_theory/definitions/countable/) set and $\left. \left( p_{n} \right) \right._{n \in \mathbb{N}}$ be a sequence of real numbers $p_{n} \in \left. \lbrack 0,1\rbrack \right.$ such that $\sum_{n \in \mathbb{N}}p_{n} = 1$. On $\left. \left( \Omega,\mathcal{P}\left. (\Omega) \right. \right) \right.$ the [set_function](/notes/areas/mathematics/set_theory/definitions/set_function/)
>
> 
...
>
> defines a [probability_measure](/notes/areas/mathematics/measure_theory/definitions/probability_measure/). The triplet $\left. \left( \Omega,\mathcal{P}\left. (\Omega) \right.,P \right) \right.$ is called a discrete [probability_space](/notes/areas/mathematics/measure_theory/definitions/probability_space/).

(M${}_{0}$): That $\mathcal{P}\left. (\Omega) \right.$ is a [sigma-algebra](/notes/areas/mathematics/measure_theory/definitions/sigma-algebra/) is given.

(M${}_{1}$): Since the empty set contains no elements, $P\left. (\varnothing) \right. = \sum_{n:\omega_{n} \in \varnothing}p_{n} = \sum_{n \in \mathbb{N}}p_{n}\delta_{\omega_{n}}\left. (A) \right.$, where $\delta$ is the [Dirac_measure](/notes/areas/mathematics/measure_theory/definitions/dirac_measure/) from part (i). Since the [Dirac_measure](/notes/areas/mathematics/measure_theory/definitions/dirac_measure/) is defined as
...
> Trivial measures: Let $\left. \left( X,\mathcal{A} \right) \right.$ be a [measurable_space](/notes/areas/mathematics/measure_theory/definitions/measurable_space/) and $A \in \mathcal{A}$. Then
>
> 
...
Since $\left. \left( \Sigma_{1} \right) \right. =$(D${}_{1}$), $\left. \left( \Sigma_{2} \right) \right. =$(D${}_{2}$), and $\left. \left( \Sigma_{3} \right) \right. \Longrightarrow$(D${}_{3}$), it is clear that every [sigma-algebra](/notes/areas/mathematics/measure_theory/definitions/sigma-algebra/) is also a [Dynkin_system](/notes/areas/mathematics/measure_theory/definitions/dynkin_system/).
