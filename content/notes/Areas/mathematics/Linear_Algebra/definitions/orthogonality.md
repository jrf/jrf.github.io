...
Two vectors $x$ and $y$ in an [inner product](/notes/areas/mathematics/functional_analysis/definitions/inner_product/) space are **orthogonal** if their inner product is zero:
