...
The *point spread function* (PSF) is the response of an imaging system to a point source. It is the optical equivalent of the [impulse_response](/notes/areas/ee/definitions_theorems/signals_systems/impulse_response/) in systems theory.
...
The image $g(x)$ of an object $f(x)$ is then given by [convolution](/notes/areas/mathematics/definitions_theorems/real_analysis/convolution/):
